...
| Doc | Purpose |
|-----|---------|
| [stack-setup.md](./stack-setup.md) | Setup checklist + **build todo** (Phases 1–14) |
| [build-plan.md](./build-plan.md) | Master build plan for Phases 6–14 |
| [testing-plan.md](./testing-plan.md) | E2E/API catalog; isolated DB per run |
